    ...
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col font-sans antialiased">
      ...
      <header className="px-5 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3 cursor-default">
          <div className="w-10 h-10 bg-gradient-to-r from-[#128a42] via-[#facc15] to-[#d92323] p-[2px] rounded-2xl shadow-lg hover:scale-105 transition-transform">
            <div className="w-full h-full bg-zinc-950 rounded-[14px] flex items-center justify-center">
              <span className="text-sm font-black">🅿</span>
            </div>
          </div>
          <div className="flex flex-col">
            <span className="font-display font-extrabold text-lg tracking-tighter text-white">PARKme <span className="text-[#128a42]">Ethiopia</span></span>
            <span className="text-[9px] font-bold tracking-wider text-[#128a42] uppercase -mt-0.5">ፓርክም · ኢትዮጵያ</span>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <Link href="/auth/register" className="bg-[#128a42] hover:bg-[#0f7a39] text-white px-5 py-2 rounded-2xl text-xs font-bold transition-all shadow-lg shadow-[#128a42]/20 active:scale-95">Get Started</Link>
        </div>
      </header>

      <section className="flex-1 flex flex-col items-center justify-center px-6 text-center pt-10 pb-16">
        <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-[#128a42] via-[#facc15] to-[#d92323] p-[2px] mb-8 shadow-2xl shadow-[#128a42]/20 hover:rotate-6 transition-transform">
        ...
        <h1 className="font-display font-extrabold text-4xl sm:text-5xl md:text-6xl leading-[1.05] mb-4 tracking-tight">
          Park Smarter<br /><span className="text-[#128a42]">Across Ethiopia</span>
        </h1>
        ...
        <div className="w-full max-w-sm space-y-3">
          <Link href="/search" className="block w-full py-4 bg-[#128a42] hover:bg-[#0f7a39] text-white rounded-2xl font-black text-base text-center transition-all shadow-xl shadow-[#128a42]/20 active:scale-[0.98]">🔍 Find Parking Near You</Link>
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto text-center mb-12">
          <h2 className="font-display font-extrabold text-2xl sm:text-3xl mb-3">How It <span className="text-[#128a42]">Works</span></h2>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            <div key={s.step} className={`p-6 bg-white/5 rounded-3xl border text-center space-y-4 transition-all ${hoveredCard === Number(s.step) ? "border-white/30 bg-white/10 scale-[1.02]" : "border-white/10"}`}
              ...
              <div className="w-12 h-12 mx-auto rounded-2xl flex items-center justify-center text-2xl" style={{ backgroundColor: s.color + "15" }}>{s.icon}</div>
              <div className="font-mono text-[10px] font-bold tracking-widest uppercase" style={{ color: s.color }}>Step {s.step}</div>
      ...
      <section className="px-6 py-20 bg-zinc-900/30 border-y border-white/5">
        <div className="max-w-4xl mx-auto text-center mb-12">
          <h2 className="font-display font-extrabold text-2xl sm:text-3xl mb-3">Popular <span className="text-[#facc15]">Locations</span></h2>
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto text-center mb-12">
          <h2 className="font-display font-extrabold text-2xl sm:text-3xl mb-3">Why <span className="text-[#d92323]">PARKme</span>?</h2>
      ...
      <section className="px-6 py-20 bg-gradient-to-br from-[#128a42]/10 via-transparent to-[#facc15]/5 border-y border-white/5">
        <div className="max-w-2xl mx-auto text-center space-y-6">
          ...
          <h2 className="font-display font-extrabold text-2xl sm:text-3xl">Own a Parking Space?<br /><span className="text-[#128a42]">Start Earning Today</span></h2>
          ...
          <Link href="/host" className="inline-block px-8 py-4 bg-[#128a42] hover:bg-[#0f7a39] text-white rounded-2xl font-black text-base transition-all shadow-xl shadow-[#128a42]/20 active:scale-[0.98]">💰 Become a Host</Link>
        </div>
      </section>
      ...
      <section className="px-6 py-20 text-center">
        ...
        <div className="w-full max-w-sm mx-auto space-y-3">
          <Link href="/auth/register" className="block w-full py-4 bg-[#128a42] hover:bg-[#0f7a39] text-white rounded-2xl font-black text-base text-center transition-all shadow-xl shadow-[#128a42]/20 active:scale-[0.98]">Create Free Account</Link>
      ...
      <footer className="px-6 py-10 border-t border-white/5">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="font-display font-extrabold text-sm text-white mb-3">PARKme <span className="text-[#128a42]">Ethiopia</span></div>
